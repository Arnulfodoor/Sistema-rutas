...
<body>
	...
	<header class="navbar-fixed index-1">
			...
			<div class="container">
				<div class="nav-wrapper">
					...
					<ul class="right hide-on-med-and-down">
											...
											<li>
												<a href="javascript:void(0)" 
												   ...
												   token_status="<?php echo $value['token_status']; ?>"
													...
													Te han escrito una nueva información en:
													<br>
						...
						<?php else: ?><li><a href="<?php echo URL; ?>login" class="waves-effect waves-light btn  red darken-1">login</a></li>
						<?php endif; ?>
		...
		<ul class="sidenav" id="nav-movil">
			<li><a href="<?php echo URL; ?>estudaintes">Estudiantes</a></li>
		</ul>
	</header>
